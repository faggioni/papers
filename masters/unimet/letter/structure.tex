...
\usepackage[dvips,eps]{graphicx} % Required for including pictures
...
\geometry{
	...
	left=2.50cm, % Left margin
	right=2.50cm, % Right margin
...
\address{
 % Include the logo of author institution
	\hspace{0.42\textwidth} % Position of the institution logo, increase to move left, decrease to move right
...
\renewcommand{\opening}[1]{
	{\fromaddress\vspace{0.05\textheight} \\ % Print the header and from address here, add whitespace to move date down
	\flushright \hspace*{\longindentation} Caracas, 16 de Octubre de 2.019 \hspace*} % Print today's date, remove \today to not display it
